...
def main():
    ...
    l_train, m_train, _ = get_latents_mrls(model, train_df, args.batch_size, device, "Precomputing Train Subset Latents")
    ...
    for bin_position, current_bin in enumerate(bin_values):
        ...
        for epoch in range(args.epochs):
            ...
            print(f"Bin {current_bin} Epoch {epoch+1}...")
            for latents, mrls in current_train_loader:
